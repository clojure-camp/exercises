{:title
 ...
 :difficulty :mid
 :instructions
 {:en-US ["Use the `java.security.MessageDigest` class from the Java standard library to write a function that generates the hexadecimal-encoded SHA-256 hash of an input string."
          ...
          [:file
           ...
           "byte[] dig = md.digest()"]
          "You can convert a byte to its hex representation in Clojure using `(format \"%02x\" the-byte)`"]
